...
void CreateInverseKinematics(pybind11::module& module)
{
    ...
    py::class_<HumanIK>(module, "HumanIK")
        ...
        .def("resetWorldAnchorTranslation", &HumanIK::resetWorldAnchorTranslation)
        .def("resetJointState", &HumanIK::resetJointState)
        .def("recenterWorldAnchor", &HumanIK::recenterWorldAnchor)
