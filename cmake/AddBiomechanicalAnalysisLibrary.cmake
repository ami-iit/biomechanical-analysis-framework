...
function(add_biomechanical_analysis_library)
  ...
  set(prefix "biomechanical_analysis_component")
  ...
  if(is_interface)
    ...
    install(FILES ${public_headers} DESTINATION "${CMAKE_INSTALL_INCLUDEDIR}/BiomechanicalAnalysis/${installation_folder}")
    install(FILES ${private_headers} DESTINATION "${CMAKE_INSTALL_INCLUDEDIR}/BiomechanicalAnalysis/${installation_folder}/impl")
    ...
    install(TARGETS    ${name}
      ...
      PUBLIC_HEADER    DESTINATION "${CMAKE_INSTALL_INCLUDEDIR}/BiomechanicalAnalysis/${installation_folder}"       COMPONENT dev
      PRIVATE_HEADER   DESTINATION "${CMAKE_INSTALL_INCLUDEDIR}/BiomechanicalAnalysis/${installation_folder}/impl"  COMPONENT dev)
  ...
  foreach(header ${public_headers})
    ...
    if ((extension STREQUAL ".h") OR (extension STREQUAL ".hpp"))
      ...
      set(include_command "#include <BiomechanicalAnalysis/${installation_folder}/${header_name}>")
  ...
  if (NOT ${skip_install_check})
    foreach(header ${public_headers})
      ...
      string(REPLACE "include/BiomechanicalAnalysis/" "" header_path_cleaned ${header_path})
      if (NOT(${header_path_cleaned} STREQUAL ${installation_folder}))
          string(REPLACE "include/" "" header_no_include ${header})
          message(FATAL_ERROR "The file ${header_no_include} will have a different path when installed (it will become BiomechanicalAnalysis/${installation_folder}/${header_name}), possibly causing issues in the client libraries.")
      endif()
    endforeach()
  endif()

  # add alias
  add_library(BiomechanicalAnalysis::${name} ALIAS ${name})
  ...
  set_property(GLOBAL APPEND PROPERTY BiomechanicalAnalysisFramework_TARGETS ${name})
